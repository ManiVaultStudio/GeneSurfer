...
class GeneSurferConan(ConanFile):
    ...
    name = "GeneSurfer"
    description = """Viewer for exploring localized transcriptome-wide gene co-expression patterns in the 3D spatial domain"""
    topics = ("manivault", "plugin", "viewer")
    url = "https://github.com/ManiVaultStudio/GeneSurfer"
    author = "c.li1@lumc.nl"  # conan recipe author
    license = "LGPL 3.0"
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/GeneSurfer")
        cmake.verbose = True
        return cmake
